...
// El backend expone /auth/login con OAuth2PasswordRequestForm (username + password)
// y devuelve { access_token, token_type }.
export const authApi = {
  login: ({ usuario, password }) =>
    api.postForm('/auth/login', { username: usuario, password }),
  perfil: (token) => api.get('/auth/me', token),
}
